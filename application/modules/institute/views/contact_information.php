...
<div class="dashboard-panel">
	...
	<div class="dashboard-list">
		<div class="update-profile">
			<div><a href="<?php echo URL_INSTITUTE_PROFILE_INFO?>"><?php echo get_languageword('View Public Profile');?> <i class="fa fa-angle-double-right"></i></a></div>
			<div><a href="<?php echo base_url()?>institute/update-contact-information"><i class="fa  fa-pencil-square-o"></i> &nbsp;<?php echo get_languageword('Update Info');?></a></div>
		</div>
