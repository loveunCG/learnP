...
// neatPrint($subjects);
if(count($courses) > 0) { ?>
<?php echo form_open('student/manage-courses', 'id="student_subject_mngt" class="form-multi-select"');?>
		...
		foreach($val as $key1=>$val1) 
		{
			...
			?>
				<div class="input-group ">
					<div class="checkbox">
						<label>
						<input type="checkbox" value="<?php echo $course_id;?>" name="student_courses[]" <?php if(in_array($course_id, $studnentPrefferedCourseIds)) echo "checked";?>>
