...
<?php echo form_open('student/manage-locations', 'id="student_subject_mngt" class="form-multi-select"');?>
		...
		foreach($val as $sub) 
		{
			...
			?>
				<div class="input-group ">
					<div class="checkbox">
						<label>
						<input type="checkbox" value="<?php echo $sub->id?>" name="student_locations[]" <?php if(in_array($sub->id, $studentLocationIds)) echo "checked";?>>
