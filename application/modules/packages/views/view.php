		  ...
		  <div class="panel-heading main_small_heding"><?php echo isset($pagetitle) ? $pagetitle :  get_languageword('no_title');?>
            ...
            <div class="form-group filerSear clearfix">        
              <div class="col-lg-3 col-sm-3 col-xs-12 padding-l">
               <select name="multioperation" id="multioperation" onchange="javascript:multioperationfunction(this.value, '<?php echo URL_PACKAGE_DELETE_RECORD;?>', '<?php echo URL_PACKAGE_STATUSTOGGLE;?>')">
                ...
                <table width="100%" class="digiTable" id="table-id">
                  <thead>
                    <tr>
					  ...
					  <th><?php echo get_languageword('package_title');?> </th>
					   <th><?php echo get_languageword('package_cost');?> </th>
