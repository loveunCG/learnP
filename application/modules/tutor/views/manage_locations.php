...
<?php echo form_open('tutor/manage-locations', 'id="tutor_subject_mngt" class="form-multi-select"');?>
		...
		foreach($val as $sub) 
		{
			...
			?>
				<div class="input-group ">
					<div class="checkbox">
						<label>
						<input type="checkbox" value="<?php echo $sub->id?>" name="tutor_locations[]" <?php if(in_array($sub->id, $tutorLocationIds)) echo "checked";?>>
